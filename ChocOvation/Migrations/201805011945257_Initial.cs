    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        CEOsID = c.String(name: "CEO's ID", nullable: false, maxLength: 128),
                        FactoryID = c.Int(nullable: false),
                        Location = c.String(),
                        AnualProfit = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.CEOsID)
                .ForeignKey("dbo.AspNetUsers", t => t.CEOsID)
                .Index(t => t.CEOsID);
                ...
                c => new
                    {
                        ...
                        PriceQuality = c.Single(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        CostPerItem = c.Int(nullable: false),
                        DepartentID = c.Int(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Factory", "CEO's ID", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Factory", new[] { "CEO's ID" });
